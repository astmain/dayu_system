...
async function make_data() {
    ...
    let position = [{position: "主管"}, {position: "职员"},]
    await db.tb_depart.create({data: {id: 1, depart: "大宇三维打印", parent_id: 0, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 2, depart: "客户", parent_id: 1, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 3, depart: "内部人员", parent_id: 1, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 4, depart: "技术部", parent_id: 1, ref_position: {create: position}}})

    await db.tb_depart.create({data: {id: 5, depart: "泉州分公司", parent_id: 1, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 6, depart: "财务部", parent_id: 5, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 7, depart: "业务部", parent_id: 5, ref_position: {create: position}}})

    await db.tb_depart.create({data: {id: 8, depart: "德化分公司", parent_id: 1, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 9, depart: "财务部", parent_id: 8, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 10, depart: "业务部", parent_id: 8, ref_position: {create: position}}})

    await db.tb_depart.create({data: {id: 11, depart: "厦门分公司", parent_id: 1, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 12, depart: "财务部", parent_id: 11, ref_position: {create: position}}})
    await db.tb_depart.create({data: {id: 13, depart: "业务部", parent_id: 11, ref_position: {create: position}}})
