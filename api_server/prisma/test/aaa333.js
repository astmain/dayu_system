...
// 菜单表
let tb_menu = [
    {id: 1, menu: "首页", path: "/home", parent: 0},
    {id: 2, menu: "关于", path: "/about", parent: 0},
    {id: 3, menu: "订单管理", path: "/order_manage", parent: 0},
    {id: 4, menu: "权限管理", path: "/system", parent: 0},//有child 4
    {id: 5, menu: "用户管理", path: "/user/user", parent: 4},
    {id: 6, menu: "菜单管理", path: "/menu/menu", parent: 4},
    {id: 7, menu: "角色管理", path: "/role/role", parent: 4},
]
...
let role_user = [
    ...
    {id: 3, role_id: 1, user_id: 3},//张三    -用户
    {id: 4, role_id: 3, user_id: 4},//李四    -商家
]

// 查询条件用户的id
let id = 1 //      username: "admin",

//根基上面的数据,帮我生产一个菜单树   

// 生成菜单树的函数
function generateMenuTree(userId) {
    // 1. 获取用户的所有角色ID
    ...
    // 3. 获取所有相关的菜单项
    const userMenus = tb_menu.filter(menu => menuIds.includes(menu.id));
...
// 使用示例
const menuTree = generateMenuTree(id);
