...
export default {
    ...
    methods: {
        async met1() {
            ...
            let img = texture.load('/src/public/pikaqiu_02.jpg')
            ...
            // 创建材质-外观
            // let my_Material = new THREE.MeshBasicMaterial({ map: img, })
            let my_Material = new THREE.MeshStandardMaterial({
                color: colorHex.red,  //颜色
                emissive: colorHex.green,//自发光-反色的颜色
                emissiveIntensity: 0.5,//自发光强度
            })//标准网格材质
            // let my_Material = new THREE.MeshBasicMaterial({ color: colorHex.red, })//标准网格材质
