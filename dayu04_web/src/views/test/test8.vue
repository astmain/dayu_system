...
export default {
    ...
    methods: {
        async met1() {
            ...
            camera.position.set(0, 20, 20)          //看的角度  1倾斜 2 旋转 3远近
            ...
            let texture = new THREE.TextureLoader().load("/src/public/地板砖01.jpg")
            let my_mesh = new THREE.Mesh(
                // 结构
                new THREE.PlaneGeometry(10, 10),
                // 材质-外观  
                // api文档  贴图不同材质   http://www.yanhuangxueyuan.com/threejs/docs/index.html?q=Material#api/zh/materials/Material
                // 视频教程               https://www.bilibili.com/video/BV1Zm421g7oi?p=7
            ...
            // my_mesh.position.set(-Math.PI / 2, 0, 0)
            my_mesh.position.x = -Math.PI / 2
