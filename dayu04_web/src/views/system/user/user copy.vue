    ...
    <el-dialog v-if="show.update" v-model="show.update" title="修改用户" width="500px" draggable>
      <div style="display: flex;">
        ...
        <div>
          ...
          <com_form ref="com_form_ref" :form_make="form_update" :modelValue="form_update" />
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      form_update: {
        data: [
          { key: "username", label: "用户名", type: "input", width_label: "60px" },
          { key: "tel", label: "电话", type: "input", width_label: "60px" },
        ]
        ,
        rules: {
